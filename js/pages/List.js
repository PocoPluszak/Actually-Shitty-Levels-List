...
export default {
        ...
        {{ level?.name || 'Error (' + err + '.json)' }}
            ...
            <div class="meta-container">
                <div class="meta">
                    ...
                    <p>
                        Once a level falls onto the Legacy List,
                        we accept records for it for 24 hours after
                        it falls off, then afterwards we never accept
                        records for said level
                    </p>
                </div>
            </div>
        </main>
    ...
    computed: {
        ...
        platform() {
            return getPlatform(this.currentVideoUrl);
        },

        tiktokId() {
            return getTikTokIdFromUrl(this.currentVideoUrl);
        },

        video() {
            return embed(this.currentVideoUrl);
        },
    },
